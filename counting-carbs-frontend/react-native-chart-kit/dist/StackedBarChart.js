...
var StackedBarChart = /** @class */ (function (_super) {
    ...
    StackedBarChart.prototype.render = function () {
        ...
        <Svg height={height} width={width}>
          ...
          <G>
            {this.renderBars(__assign(__assign({}, config), { data: data.data, border: border, colors: this.props.data.barColors, paddingTop: paddingTop, paddingRight: paddingRight + 28, stackedBar: stackedBar,
            verticalLabelsHeightPercentage: verticalLabelsHeightPercentage }))}
          </G>
          {showLegend &&
